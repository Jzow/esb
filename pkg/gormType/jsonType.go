...
// Parse return json.RawMessage
func Parse(obj interface{}) (JSON, error) {
	var bytes JSON
	bytes, err := json.Marshal(obj)
	if err != nil {
		return nil, errors.New("failed to gormType.Parse," + err.Error())
	}
	return bytes, nil
}

// Unmarshal obj
func (j JSON) Unmarshal(obj any) error {
	return json.Unmarshal([]byte(j.String()), obj)
}
